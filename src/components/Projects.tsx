...
export const Projects: React.FC<ProjectsProps> = ({
  ...
  const categories = ['All', 'Education', 'Healthcare', 'Clean Water', 'Community', 'Environment'];
  ...
  return (
    <section id="projects" className="py-20 sm:py-28 bg-[#F5F5F5] dark:bg-[#152317] transition-colors duration-300">
